...
<head>
    ...
    <script>
        ...
        function checkPhone(){
            ...
            var regPhone = /\b\d{12}\b/;
            if(regPhone.test(phone) == false){
                codePhone.innerHTML = "请输入正确的学号(学号为12位数字)";
                return false;
            }
            codePhone.innerHTML = "";
            return true;
...
<div id="main">
    ...
    <div id="window">
        ...
        <div id="w_iphone">
            ...
            <input  id="iphone" type="text" name="stuNo" value="请输入学号"
                    onFocus="if (value =='请输入学号'){value =''}" onBlur="if (value ==''){value='请输入学号'} checkPhone()"/>
        </div>
            <div id="check_iphone"></div>
        <div id="w_password">
            <div id="password_img"></div>
            <input  id="password" type="text" name="stuPassword"  value="请输入密码"
        ...
        <div id="login">
            <input id="submit" type="submit" name="submit" value="学     生     登     录">
        </div>
        </form>
    </div>
    <div id="last">
