...
<body class="easyui-layout">
	<div id="north" data-options="region:'north',split:true" style="height:110px;">
		...
		<div id="n_login_name" onclick="showName()"><a>${stu.stuName}</a></div>
		<div id="n_login_no" hidden="true">${stu.stuNo}</div>
		<div id="n_right">明德 博学 守正 出奇</div>
	</div>
	<div id="south" data-options="region:'south',split:true" style="height:70px;">
		<div id="s_last">
			<div id="weixin_logo">
	...
	<div id="west" data-options="region:'west',title:'菜单',split:true" style="width:150px;">
...
// 		data:jsdata,
		...
		columns:[[
			...
			{field:'teacherNo',title:'教师编号',width:120,hidden:true},
			{field:'teachermess',title:'任课教师',width:150,align:'center',formatter:function(value){
				return value.techName;
			}},
			{field:'courseTime',title:'学时',width:120,align:'center'},
			{field:'courseScore',title:'学分',width:120,align:'center'},
			{field:'courseDescribe',title:'课程描述',width:120,align:'center'},
			{field:'courseNumber',title:'剩余人数',width:120,align:'center'},
			{field:'courseStatus',title:'选课状态',width:120,align:'center',formatter:option}
		]]
	});
	//分页内容发中文显示
...
// 			data:jsdata,
			...
			columns:[[
				...
				{field:'courseName',title:'课程名称',width:150,align:'center'},
				{field:'teacherNo',title:'教师编号',width:120,hidden:true},
				{field:'teachermess',title:'任课教师',width:120,align:'center',formatter:function(value){
					return value.techName;
				}},
				{field:'courseTime',title:'学时',width:120,align:'center'},
				{field:'courseScore',title:'学分',width:120,align:'center'},
				{field:'courseDescribe',title:'课程描述',width:120,align:'center'},
				{field:'courseNumber',title:'剩余人数',width:120,align:'center'},
				{field:'courseStatus',title:'选课状态',width:120,align:'center',formatter:options}
			]]
		});
	...
	function options(value, row, index) {
		if (row.courseStatus == "1") {
			return '<a id="d_achoose" href="#" onclick="deleteClass('+index+')">退课</a>';
		} else {
